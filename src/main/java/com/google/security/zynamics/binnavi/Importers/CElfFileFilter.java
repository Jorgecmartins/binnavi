 ...
 */
public final class CElfFileFilter extends FileFilter {
  @Override
  public boolean accept(final File file) {
    ...
    if (!filenameLower.endsWith(".idb") && !filenameLower.endsWith(".i64") && 
        !filenameLower.endsWith(".c") && !filenameLower.endsWith(".asm") &&
        !filenameLower.endsWith(".nam") && !filenameLower.endsWith(".id0") &&
        !filenameLower.endsWith(".id1")) {
      return true;
    }
