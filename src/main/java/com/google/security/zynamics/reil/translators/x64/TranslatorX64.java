...
/**
 * Translator class that translates x64 code to REIL code
 * 
 * sp
 * 
 */
public class TranslatorX64<InstructionType extends IInstruction> implements
  ...
  static {
    try {
      ...
      translators.put("jrcxz", new JccTranslator(new RcxZeroGenerator()));
      ...
      translators.put("lodsq", new LodsqTranslator());
      ...
      translators.put("rep lodsq", new RepTranslator(new LodsGenerator(), OperandSize.QWORD));
      ...
      translators.put("repe scasq", new RepeTranslator(new ScasGenerator(), OperandSize.QWORD));
      ...
      translators.put("scasq", new ScasdTranslator());
