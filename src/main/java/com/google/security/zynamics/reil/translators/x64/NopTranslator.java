...
/**
 * Translates NOP instructions to REIL code.
 */
public class NopTranslator implements IInstructionTranslator {
  /**
   * Translates a NOP instruction to REIL code.
   * 
   * @param environment A valid translation environment.
   * @param instruction The NOP instruction to translate.
