...
/**
 * Translates MOVS instructions to REIL code.
 */
public class MovsGenerator implements IStringInstructionGenerator {

  /**
   * Translates a MOVS instruction to REIL code.
   *
   * @param environment A valid translation environment.
   * @param baseOffset The offset of the MOVS instruction to translate.
   * @param operandSize Size of the operands of the MOVS instruction.
   * @param instructions The generated REIL code will be added to this list
   *
   * @throws InternalTranslationException if any of the arguments are null the passed instruction is
   *         not a MOVS instruction
   */
  @Override
  public void generate(final ITranslationEnvironment environment, final long baseOffset,
    ...
    instructions.add(ReilHelpers.createAdd(offset + 3, archSize, "esi", archSize, ediChange,
        resultSize, tempEsi1));
    instructions.add(ReilHelpers.createAnd(offset + 4, resultSize, tempEsi1, archSize,
        truncateMask, archSize, "esi"));
    instructions.add(ReilHelpers.createAdd(offset + 5, archSize, "edi", archSize, ediChange,
        resultSize, tempEdi1));
    instructions.add(ReilHelpers.createAnd(offset + 6, resultSize, tempEdi1, archSize,
    ...
    instructions.add(ReilHelpers.createSub(offset + 8, archSize, "esi", archSize, ediChange,
        resultSize, tempEsi2));
    instructions.add(ReilHelpers.createAnd(offset + 9, resultSize, tempEsi2, archSize,
        truncateMask, archSize, "esi"));
    instructions.add(ReilHelpers.createSub(offset + 10, archSize, "edi", archSize, ediChange,
        resultSize, tempEdi2));
    instructions.add(ReilHelpers.createAnd(offset + 11, resultSize, tempEdi2, archSize,
        truncateMask, archSize, "edi"));
